...
Onboarding was ported from openzone-swifters. OpenCore uses a single `:app` Gradle module; feature boundaries are enforced by package structure and Kotlin `internal` visibility, not separate Gradle libraries.
